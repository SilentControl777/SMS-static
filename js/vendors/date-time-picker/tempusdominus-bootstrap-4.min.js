        ...
        f = function(a, b) {
            var d = "datetimepicker",
                ...
                t = {
                    ...
                    icons: {
                        time: "sms-icon-clock",
                        date: "sms-icon-calender",
                        up: "sms-icon-top-arrow",
                        down: "sms-icon-down-arrow",
                        previous: "sms-icon-left-arrow",
                        next: "sms-icon-right-arrow",
                        today: "sms-icon-calender",
                        clear: "sms-icon-delete",
                        close: "sms-icon-clock"
                    },
                    tooltips: {
                        today: "Go to today",
